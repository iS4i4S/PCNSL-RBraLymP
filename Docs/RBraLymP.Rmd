...
author: 
  - name: "Isaias Hernandez-Verdin, MSc"
...
Run the `compSurv` function in the FF cohort. Note that the full clinical data (FF cohort) is not provided, it must be downloaded from the [EGAS repository](link).
